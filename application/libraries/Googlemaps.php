...
class Googlemaps {
	...
	var $apiKey						= 'AIzaSyD_BSQBgi5siiYn_2_qtKnxNWSGErMz6Qs'; 						// If you've got an API key you can use it by passing this parameter. Setup an API key here: https://code.google.com/apis/console
	...
	function add_circle($params = array())
	{
		...
		$circle['fillColor'] = '#13B5C7';						// The hex value of the circles fill color
