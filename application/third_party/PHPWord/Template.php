    ...
    */
    public function cloneRow($search, $data=array()) {      
        ...
        if ($numberOfClones > 0) {
            ...
            // $doc = new DomDocument();
            $doc = DomDocument::loadXML($this->_documentXML, LIBXML_NOENT | LIBXML_XINCLUDE | LIBXML_NOERROR | LIBXML_NOWARNING);
            // search for tables
