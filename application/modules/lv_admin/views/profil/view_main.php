				...
				<div class="panel panel-bordered">
					<div class="panel-body">
						<div class="margin-bottom-15">
							...
							<div class="modal fade modal-newspaper" id="ganti-password" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"> 
	                          <div class="modal-dialog" id="input_new_password">
	                              <div class="modal-content modal-primary" >
	                                ...
	                                <form id="form_password_baru" name="form_password" action="<?php echo base_url().'admin/ganti-password'?>" method="post">  
		                	...
		                	<?php echo $this->session->flashdata('msg_update_profil_admin_sukses');?>
		                	...
		                	<?php endforeach;?>
		                	<a href="<?php echo base_url().'admin/profil/edit/'.$row->id_alumni;?>"><button type="button" name="button" class="btn btn-primary btn-sm btn-waves"><i class="fa fa-edit"></i> Edit Profil</button></a>
		              	</div><br>
					</div>
				</div>
			</div>
