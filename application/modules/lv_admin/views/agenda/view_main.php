	...
	<?php $this->load->view('themes/admin/sidebar'); ?>
		<div class="page animsition" style="animation-duration: 800ms; opacity: 1;">
		    <div class="page-header">
		      <h1 class="page-title">Kelola Data Agenda</h1>
		      <ol class="breadcrumb">
				...
				<div class="panel panel-bordered">
					<div class="panel-body">
						<div class="margin-bottom-15">
		              	...
		              	<?php 
	                        echo $this->session->flashdata('msg_insert_data_agenda_sukses');
	                        echo $this->session->flashdata('msg_update_data_agenda_sukses');
	                        echo $this->session->flashdata('msg_hapus_data_agenda_sukses');
	                    ?>
    							...
    							?>
		              			<tr>
		              				...
		              				<td class="text-center">
					                	<a class="btn btn-warning btn-xs" style="text-decoration:none" href="<?php echo base_url()."admin/agenda/edit/".$row->id_agenda?>"><i class="fa fa-edit"></i> Edit
					                	</a>
