...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>resources/material/base/assets/css/site.min.css" media="screen">
  <!-- Plugins -->
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>resources/material/global/vendor/waves/waves.css" media="screen">
  <link rel="stylesheet" href="<?php echo base_url() ?>resources/material/global/vendor/bootstrap-datepicker/bootstrap-datepicker.min.css?v4.0.2" media="screen">
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>resources/material/base/assets/examples/css/dashboard/v1.css" media="screen">
  <!-- Fonts -->
      ...
      <div class="collapse navbar-collapse navbar-collapse-toolbar" id="site-navbar-collapse">
        ...
        <ul class="nav navbar-toolbar navbar-right navbar-toolbar-right">
          <li class="<?php echo ($this->uri->segment(1) == 'dashboard' ? 'active' : '') ?>">
            <a href="<?php echo site_url('dashboard') ?>"><i class="fa fa-home"></i> Dashboard <span class="sr-only">(current)</span></a>
          </li>
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              <li role="presentation">
                <a href="<?php echo site_url('profil') ?>" role="menuitem"><i class="icon wb-power" aria-hidden="true"></i> Logout</a>
              </li>
              <li class="divider" role="presentation"></li> 
              <li role="presentation">
                <a href="<?php echo site_url('login') ?>" role="menuitem"><i class="icon wb-power" aria-hidden="true"></i> Logout</a>
              </li>
            </ul>
          </li>
