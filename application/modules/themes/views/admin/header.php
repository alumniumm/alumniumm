...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url() ?>resources/material/global/vendor/slidepanel/slidePanel.min.css" media="screen">
  ...
  <!-- Date Picker -->
  <link rel="stylesheet" href="<?php echo base_url() ?>resources/assets/admin/bower_components/bootstrap-datepicker/dist/css/bootstrap-datepicker.min.css">
  <!-- Fonts -->
          ...
          <li class="dropdown">
            ...
            <ul class="dropdown-menu" role="menu">
              <li role="presentation">
                <a href="<?php echo base_url('admin/profil') ?>" role="menuitem"><i class="icon wb-user" aria-hidden="true"></i> Profil</a>
              </li>
